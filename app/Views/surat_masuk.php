   ...
   <div id="wrapper">
      ...
      <div id="page-wrapper" class="gray-bg">
         ...
         <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-md-12">
               <h2> <b>Surat Masuk | </b>Adminsitrator </h2>
            </div>
         </div>
                                 ...
                                 <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                       ...
                                       <div class="modal-body">
                                          <form action="/addSM" method="post" id="addSM"></form>
                                          <div class="form-group  row">
                                             <label class="col-sm-3 col-form-label">Masukkan Nomor Surat :</label>
                                             <div class="col-sm-9">
                                                <input type="text" class="form-control" autocomplete="off" name="no_surat" form="addSM">
                                             </div>
                                          </div>
                                          <div class="form-group  row">
                                             <label class="col-sm-3 col-form-label">Masukkan Tanggal Surat :</label>
                                             <div class="col-sm-9">
                                                <input type="date" class="form-control" autocomplete="off" name="tgl_surat" form="addSM">
                                             </div>
                                          </div>
                                          <div class="form-group  row">
                                             <label class="col-sm-3 col-form-label">Masukkan Pengirim :</label>
                                             <div class="col-sm-9">
                                                <input type="text" class="form-control" autocomplete="off" name="pengirim" form="addSM">
                                             </div>
                                          </div>
                                          <div class="form-group  row">
                                             <label class="col-sm-3 col-form-label">Masukkan Perihal :</label>
                                             <div class="col-sm-9">
                                                <input type="text" class="form-control" autocomplete="off" name="perihal" form="addSM">
                                             </div>
                                          </div>
                                       </div>
                                       <div class="modal-footer">
                                          <button type="button" class="btn btn-white" data-dismiss="modal">Close</button>
                                          <button type="submit" class="btn btn-primary" form="addSM">Save changes</button>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                          ...
                                          <div class="modal inmodal fade" id="edit_<?= $d['id'] ?>" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
                                             <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                   ...
                                                   <div class="modal-body">
                                                      <form action="/updateSM" method="post" id="updateSM_<?= $d['id'] ?>"></form>
                                                      <div class="form-group  row">
                                                         <label class="col-sm-3 col-form-label">Masukkan Nomor Surat :</label>
                                                         <div class="col-sm-9">
                                                            <input type="text" class="form-control" autocomplete="off" name="no_surat" form="updateSM_<?= $d['id'] ?>" value="<?= $d['no_surat'] ?>">
                                                         </div>
                                                      </div>
                                                      <div class="form-group  row">
                                                         <label class="col-sm-3 col-form-label">Masukkan Tanggal Surat :</label>
                                                         <div class="col-sm-9">
                                                            <input type="date" class="form-control" autocomplete="off" name="tgl_surat" form="updateSM_<?= $d['id'] ?>" value="<?= $d['tgl_surat'] ?>">
                                                         </div>
                                                      </div>
                                                      <div class="form-group  row">
                                                         <label class="col-sm-3 col-form-label">Masukkan Pengirim :</label>
                                                         <div class="col-sm-9">
                                                            <input type="text" class="form-control" autocomplete="off" name="pengirim" form="updateSM_<?= $d['id'] ?>" value="<?= $d['pengirim'] ?>">
                                                         </div>
                                                      </div>
                                                      <div class="form-group  row">
                                                         <label class="col-sm-3 col-form-label">Masukkan Perihal :</label>
                                                         <div class="col-sm-9">
                                                            <input type="text" class="form-control" autocomplete="off" name="perihal" form="updateSM_<?= $d['id'] ?>" value="<?= $d['perihal'] ?>">
                                                         </div>
                                                      </div>
                                                   </div>
                                                   <div class="modal-footer">
                                                      <button type="button" class="btn btn-white" data-dismiss="modal">Close</button>
                                                      <button type="submit" class="btn btn-primary" form="updateSM_<?= $d['id'] ?>" name="id" value="<?= $d['id'] ?>">Save changes</button>
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                                             ...
                                             <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                   ...
                                                   <div class="modal-body d-flex justify-content-center align-items-center">
                                                      ...
                                                      <form action="/deleteSM" method="post" id="deleteSM_<?= $d['id'] ?>"></form>
                                                   </div>
                                                   <div class="modal-footer">
                                                      <button type="button" class="btn btn-white" data-dismiss="modal">Close</button>
                                                      <button type="submit" class="btn btn-danger" form="deleteSM_<?= $d['id'] ?>" name="id" value="<?= $d['id'] ?>">Hapus</button>
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
